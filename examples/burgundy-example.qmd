...
## Symmetry and skewness {.figure-slide}

![](figures/epidemic-curves.png){fig-align="center"}

<p class="caption">Epidemic curves for $R_0 \in \{1.5, 3, 8\}$. As $R_0$ increases, the curve sharpens and becomes more symmetric.</p>
