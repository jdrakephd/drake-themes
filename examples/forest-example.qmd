...
subtitle: "A practical overview for field ecologists"
author: "John M. Drake"
institute: "Odum School of Ecology"
event: "CEID Workshop on Disease Dynamics"
location: "Whitehall Forest, Athens, Georgia"
date: today
format:
...
## The flow diagram {.figure-dark}

![](figures/logistic-transparent.png){fig-align="center"}

<p class="caption">Logistic growth at two rates, showing how populations approach carrying capacity $K$.</p>
...
## Resources {.watermark background-image="figures/watermark.png" background-size="contain" background-position="center" background-opacity="0.10"}

Workshop materials and R scripts are available at
the CEID GitHub repository.
...
### This afternoon: hands-on session fitting models to field data
